...
Der VIP und VIS Rang sowie das Plus - Upgrade kann via [!badge variant="ghost" text="/shop"] im Spiel erworben werden.\
...
[!badge variant="dark" size="l" icon=":gem:" text="VIP (5€ / Monat)"]\
...
[!badge variant="dark" size="l" icon=":gem:" text="VIS (5€ / Monat)"]\
