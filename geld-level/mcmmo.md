...
# mcMMO [!button target="blank" size="xs" variant="success" icon=":bulb:" text="Feedback geben"](https://tally.so/r/WO8gxJ)
...
Alchemie        | Brauen von Tränken | Es werden zunehmend viele neue Rezepte für in Minecraft sonst nicht erhältliche Tränke freigeschaltet. Tränke werden außerdem zunehmend schneller gebraut. Eine Übersicht der Tränke findest du [hier](https://wiki.mcmmo.org/en/skills/alchemy) | 
